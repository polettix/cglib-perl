...
=head2 C<< clone_minus >>
   ...
   $v->minus($w);
   my $copy = $v->clone_minus($w);
   
subtract one vector from another, in modifying and cloning alternatives.
...
=head2 C<< clone_plus >>
   ...
   $v->plus($w);
   my $copy = $v->clone_plus($w);
   
sum one vector to another, in modifying and cloning alternatives.
...
=head2 C<< rotate >>
=head2 C<< clone_rotate >>

   $v->rotate($angle);
   my $copy = $v->clone_rotate($angle);

rotate a vector by C<$angle> radians.

=head2 C<< rotate_deg >>
=head2 C<< clone_rotate_deg >>

   $v->rotate_deg($angle);
   my $copy = $v->clone_rotate_deg($angle);
...
=head2 C<< clone_scale >>
   ...
   $v->scale(10);
   my $copy = $v->clone_scale(10);

Multiply each component by a factor.

=head2 C<< scaled_add >>

=head2 C<< clone_scaled_add >>

   $v->scaled_add($w, $factor);
   my $copy = $v->clone_scaled_add($w, $factor);
   # last is equivalent to $v + $factor * $w
...
=head2 C<< clone_scale_to >>

   $v->scale_to(11);
   my $copy = $v->clone_scale_to(11);
